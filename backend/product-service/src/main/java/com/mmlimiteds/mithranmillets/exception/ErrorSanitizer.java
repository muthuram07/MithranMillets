...
public class ErrorSanitizer {
    ...
    private static final Pattern PACKAGE_PATTERN = Pattern.compile("(java|com|org|net)\\.[a-z0-9.]+");
    private static final Pattern EXCEPTION_CLASS_PATTERN = Pattern.compile("(Exception|Error|Throwable)");
    ...
    public static String sanitizeMessage(String message) {
        ...
        // Remove package names (but preserve meaningful parts)
     ...
     * @param context Context where error occurred (e.g., "ProductService.getProduct")
     */
